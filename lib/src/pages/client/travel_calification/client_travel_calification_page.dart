...
import 'package:mototravel/src/pages/client/travel_calification/client_travel_calification_controller.dart';
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
      _bannerPriceInfo(),
      _listTileTravelInfo('Desde', '', Icons.location_on), 
      _listTileTravelInfo('Hasta', '', Icons.directions_subway), 
      SizedBox(height: 30),
...
Widget _buttonCalificate()
{
 ...
 Widget _ratingbar()
 {
  ...
  {
    return Text('CALIFICA A TU MOTOTAXI',
    style: TextStyle(
    color: Colors.cyan,
